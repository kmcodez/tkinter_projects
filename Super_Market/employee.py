...
class login_page():
    def __init__(self, top=None):
        ...
        self.img = PhotoImage(file='./images/employee/employee-login.png')
...
class bill_window:
    def __init__(self, top=None):
        ...
        self.img = PhotoImage(file="./images/employee/bill_window.png")
...
def login(Event=None):
    ...
    if results:
        if results[0][6] == 'Employee':
            ...
            messagebox.showerror('Oops', 'You are not an employee')
