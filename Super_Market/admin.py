...
class login_page():
    def __init__(self, top=None):
        ...
        self.img = PhotoImage(file='./images/admin/admin-login.png')
        self.label1.configure(image=self.img)

        self.entry1 = Entry(root)
        self.entry1.place(relx=0.35, rely=0.59, width=460, height=34)
        self.entry1.configure(relief='flat')
        self.entry1.configure(background='#E8E2E2')
        self.entry1.configure(font='-family {Poppins} -size 12')
        self.entry1.configure(textvariable=user)

        self.entry2 = Entry(root)
        self.entry2.place(relx=0.35, rely=0.685, width=460, height=34)
        self.entry2.configure(relief='flat')
        self.entry2.configure(background='#E8E2E2')
        self.entry2.configure(font='-family {Poppins} -size 12')
        self.entry2.configure(show='*')
        self.entry2.configure(textvariable=passwd)

        self.button1 = Button(root)
        self.button1.place(relx=0.473, rely=0.805, width=80, height=25)
        self.button1.configure(relief='flat')
        self.button1.configure(overrelief='flat')
        self.button1.configure(activebackground='#FFB100')
        self.button1.configure(cursor='hand2')
        self.button1.configure(foreground='#000000')
        self.button1.configure(background='#FFB100')
        self.button1.configure(font='-family {Poppins SemiBold} -size 15')
    ...
    def login(self, Event=None):
        ...
        find_user = 'SELECT * FROM admin WHERE adm_id = ? and password = ?'
        cur.execute(find_user, [username, password])
        results = cur.fetchall()

        if results:
        	if results[0][6] == 'Admin':
        		messagebox.showinfo('Login page', 'The login is succesful.')
...
class Admin_Page:
    def __init__(self, top=None):
        ...
        self.label1.place(relx=0, rely=0, width=1366, height=768)
        self.img = PhotoImage(file="./images/admin/admin.png")
        self.label1.configure(image=self.img)
...
class Inventory:
    def __init__(self, top=None):
        ...
        self.label1.place(relx=0, rely=0, width=1366, height=768)
        self.img = PhotoImage(file="./images/admin/inventory.png")
        self.label1.configure(image=self.img)
...
class add_product:
    def __init__(self, top=None):
        ...
        self.label1.place(relx=0, rely=0, width=1366, height=768)
        self.img = PhotoImage(file="./images/admin/add_product.png")
        self.label1.configure(image=self.img)
...
class Update_Product:
    def __init__(self, top=None):
        ...
        self.label1.place(relx=0, rely=0, width=1366, height=768)
        self.img = PhotoImage(file="./images/admin/update_product.png")
        self.label1.configure(image=self.img)
...
class Employee:
    def __init__(self, top=None):
        ...
        self.label1.place(relx=0, rely=0, width=1366, height=768)
        self.img = PhotoImage(file="./images/admin/employee.png")
        self.label1.configure(image=self.img)
...
class add_employee:
    def __init__(self, top=None):
        ...
        self.label1.place(relx=0, rely=0, width=1366, height=768)
        self.img = PhotoImage(file="./images/admin/add_employee.png")
        self.label1.configure(image=self.img)
...
class Update_Employee:
    def __init__(self, top=None):
        ...
        self.label1.place(relx=0, rely=0, width=1366, height=768)
        self.img = PhotoImage(file="./images/admin/update_employee.png")
        self.label1.configure(image=self.img)
...
class Invoice:
    def __init__(self, top=None):
        ...
        self.label1.place(relx=0, rely=0, width=1366, height=768)
        self.img = PhotoImage(file="./images/admin/invoices.png")
        self.label1.configure(image=self.img)
...
class open_bill:
    def __init__(self, top=None):
        ...
        self.img = PhotoImage(file="./images/admin/bill.png")
        self.label1.configure(image=self.img)
